...
public class WxGoodsController {
     ...
     *            分页大小
     * @param sort
     *            排序方式，支持"add_time", "retail_price"或"name"
     * @param order
     *            排序类型，顺序或者降序
     * @return 根据条件搜素的商品详情
     */
    ...
    public Object list(Integer categoryId, Integer brandId, String keyword, Boolean isNew, Boolean isHot,
            ...
            @Sort(accepts = { "add_time", "retail_price",
                    "name" }) @RequestParam(defaultValue = "add_time") String sort,
        ...
        // 查询列表数据
        List<LitemallGoods> goodsList = goodsService.querySelective(categoryId, brandId, keyword, isHot, isNew, page,
                size, sort, order);
