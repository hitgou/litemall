...
public class Jackson2JsonRedisSerializer<T> implements RedisSerializer<T> {
	 ...
	 * for specific types. The other option for refining the serialization process
	 * is to use Jackson's provided annotations on the types to be serialized, in
	 * which case a custom-configured ObjectMapper is unnecessary.
	 */
	 ...
	 * {@link TypeFactory#constructType(java.lang.reflect.Type)}, but this can be
