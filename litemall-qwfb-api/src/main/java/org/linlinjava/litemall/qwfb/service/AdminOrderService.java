...
import static org.linlinjava.litemall.qwfb.util.ResponseCode.ORDER_CONFIRM_NOT_ALLOWED;
import static org.linlinjava.litemall.qwfb.util.ResponseCode.ORDER_REFUND_FAILED;
import static org.linlinjava.litemall.qwfb.util.ResponseCode.ORDER_REPLY_EXIST;
...
public class AdminOrderService {
     ...
     * 管理员登录微信官方支付平台点击退款操作进行退款 2. 管理员登录litemall管理后台点击退款操作进行订单状态修改和商品库存回库
     *
     * @param body
     *            订单信息，{ orderId：xxx }
     * @return 订单退款操作结果
