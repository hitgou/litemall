	...
	function hz6d_cus_web_msg_open(){
		var openurl = "https://www16.53kf.com/webCompany.php?arg=10195265&style=1&kflist=off&kf=&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Flocalhost%3A9527%2F%23%2Fgoods%2Flist&keyword=http%3A%2F%2Flocalhost%3A9527%2F&brief=&logo=&question=&uid=8ba83dfc9d42be9ad1e4d0eb65a95a51";
		try{
...
//	hz6d_get_guest_id_timer = setTimeout("hz6d_get_guest_id()", 500);
	...
	var create_flp_jquery_timer = window.setInterval(function(){
		if (!document.getElementById('hz6d_flp_jquery')) {
			$53.creElm({
				id: 'hz6d_flp_jquery',
				src: 'https://www16.53kf.com/minkh/js/jquery-1.4.2.flp.js?20121127002',
				charset: "utf-8",
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
            ...
            var ivt_autotype           = "0";
			var zdyivt						= "0";
			var ivtstr						= "<div id=\"inv_box_53kf\" style=\"width: 380px; padding-top: 10px; padding-left: 10px; box-sizing: border-box; position: fixed; left:412px; top:22px;display: block;z-index:999998;\"><div style=\"position:absolute;left:0;top:0;width:20px;height:20px;cursor:pointer;z-index:5;\" onclick = \"inv.clos()\"><img style=\"width:100%;height:100%;\" src=\"https://talk.71baomu.com/style/setting/ver07/img/style_mobile_invite/close_2x.png\"></div><div class=\"inv_bg_color\" style=\"width:100%;box-sizing: border-box;overflow:hidden;background:#FFFFFF; border:1px solid #eee; box-shadow:rgba(74, 144, 226, 0.4) 0px 0px 10px 0px;border-radius: 2px;\"><div class=\"img_bg\" style=\"background:url(https://www16.53kf.com/style/setting/ver07/img/style_setting_ivt/kf-tb-01.png?1);background-size: 100% 100%; width: 100%;height: 140px;\"></div><div style=\"padding:16px 16px 24px 16px;overflow: hidden\"><div class=\"inv_title\" style=\"font-size:22px;text-align:center;float:left;width:100%;line-height:32px;margin-bottom:8px;letter-spacing:1px;box-sizing:border-box;color:#3A3C4C;\">你好</div><div class=\"inv_content\" style=\"font-size: 14px; line-height: 20px;  text-align: left; max-height: 60px; overflow: auto; float: left; width: 100%; margin-bottom: 16px; word-wrap: break-word; color: #3A3C4C;\">我邀请你</div><div class=\"talk_btn\" style=\"float:left;width:100%;border-radius:2px;height:44px;line-height:44px;letter-spacing: 0.83px;font-size:16px;text-align:center;cursor:pointer;color:#FFFFFF;background:#1F8CEB;\" onclick=\"inv.talk()\">点击咨询</div></div></div></div>";
			var is_autoyqk				= "0";
		...
		//	var acc_poptype			 = -1;
			...
			if ((pc_ivt_type == '2' || pc_ivt_type == '-1') && 0 == '0') {
			    		...
			    		Inv.prototype = {
			    			...
			    			talk : function(){
			    				...
			    				if (zdfq_type == 3) {
			    					...
			    					var openurl = "https://www16.53kf.com/webCompany.php?arg=10195265&style=1&kflist=off&kf=&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Flocalhost%3A9527%2F%23%2Fgoods%2Flist&keyword=http%3A%2F%2Flocalhost%3A9527%2F&brief=&logo=&question=&uid=8ba83dfc9d42be9ad1e4d0eb65a95a51&tfrom=2" + force_kf;
			    					onliner_zdfq=2;
				...
				if(0 == 1){
					btn_style1 = 'background: center center no-repeat;background-image: url(https://www16.53kf.com/style/chat/new2017/image/png/img-info24.png);background-image: url(https://www16.53kf.com/style/chat/new2017/image/svg/img-info24.svg), none;'
					btn_style2 = 'position: relative;height: 100%;width: 100%;background: center center no-repeat;background-color: '+minicolor_tbbj+';background-image: url(https://www16.53kf.com/style/chat/new2017/image/png/img-info36.png);background-image: url(https://www16.53kf.com/style/chat/new2017/image/svg/img-info36.svg), none;'
				}else {
					btn_style1 = 'background: center center no-repeat;background-image: url(https://www16.53kf.com/style/chat/new2017/image/png/img-email24.png);background-image: url(https://www16.53kf.com/style/chat/new2017/image/svg/img-email24.svg), none;'
					btn_style2 = 'position: relative;height: 100%;width: 100%;background: center center no-repeat;background-color: '+minicolor_tbbj+';background-image: url(https://www16.53kf.com/style/chat/new2017/image/png/img-email36.png);background-image: url(https://www16.53kf.com/style/chat/new2017/image/svg/img-email36.svg), none;'
				...
				if(mini_style_type==1){
					bubble_html = '<div class="mini-btn mini-btn1" id="mini-btn" onclick="show_floatWindow();" style="width:auto;white-space:nowrap;cursor:pointer;'+mini_btn_display+'position:absolute;'+mini_button_position+'z-index:-1;height: 42px;border-radius:2px; overflow: hidden; background: '+minicolor_tbbj+';-webkit-box-shadow: 0 1px 6px rgba(0, 0, 0, .06), 0 2px 32px rgba(0, 0, 0, .16)!important;box-shadow: 0 1px 6px rgba(0, 0, 0, .06), 0 2px 32px rgba(0, 0, 0, .16)!important;">'+
										...
										'<div class="mini-btn-window" style="display:inline-block;width: 42px;height: 42px;background: center center no-repeat;background-image: url(https://www16.53kf.com/style/chat/new2017/image/png/to-maxWindow.png);background-image: url(https://www16.53kf.com/style/chat/new2017/image/svg/to-maxWindow.svg), none;"></div>'+
									'</div>';
				...
				tmp_innerHTML += '<div id="iframe_company_mini_div" style="'+mini_div_display+'font-size: 0;background-color:#fff;border-radius:2px;overflow:hidden;width:100%;height:'+mini_size_height+'px;box-shadow:0 5px 40px rgba(0,0,0,.16)!important;-webkit-box-shadow:0 5px 40px rgba(0,0,0,.16)!important;">'+
									'<h6 class="pc-visitor-header" style="width:100%;box-sizing:border-box;background: '+minicolor_tbbj+' no-repeat 10px;margin:0;padding:0;padding-left: 42px;font-size: 14px;color: #fff;height: 36px;line-height: 36px;position: relative;font-weight: normal;padding-right: 72px;">'+
										'<img style="width:24px;height:24px;position:absolute;left:10px;top:6px;border-radius:2px;" src="https://www16.53kf.com/img/upload/10195265/mobile/temp/mobile_53kf_1550564757.png"/>'+
	...
	//↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑  2017版访客端新增 ↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑↑
			...
			function cgpic(t){
				if( $53("div_company_mini").style.width =="400px"){
					document.querySelector('.mini_narrow').style.background="url('https://www16.53kf.com/style/chat/minichat2/img/minx1.png') no-repeat";
				}

			}
			function cgpic2(t){
				if( $53("div_company_mini").style.width =="400px"){
					document.querySelector('.mini_narrow').style.background="url('https://www16.53kf.com/style/chat/minichat2/img/minx2.png') no-repeat";
				}
			}
			function cgpic3(t){
				document.querySelector('.mini_maxto').style.background="url('https://www16.53kf.com/style/chat/minichat2/img/double1.png') no-repeat";
			}
			function cgpic4(t){
				document.querySelector('.mini_maxto').style.background="url('https://www16.53kf.com/style/chat/minichat2/img/double2.png') no-repeat";
			}
			function cgpic5(t){
				document.querySelector('.mini_close').style.background="url('https://www16.53kf.com/style/chat/minichat2/img/close1.png') no-repeat 50% 50%";
			}
			function cgpic6(t){
				document.querySelector('.mini_close').style.background="url('https://www16.53kf.com/style/chat/minichat2/img/close2.png') no-repeat 50% 50%";
			}
			...
			function max_min_company_mini(t)
			{
				if (t.getAttribute('max_min') == 'max')
				{
					...
					t.style.backgroundImage = "url('https://www16.53kf.com/style/chat/minichat2/img/max.png')";
					t.setAttribute('max_min','min');
					t.title = t.getAttribute('mini_recover');
                    $53("div_company_mini").style.right = '0px';
			     	$53("div_company_mini").style.bottom = '0px';                    $53("mini_header_bg_div").style.backgroundImage = "url('https://www16.53kf.com/style/chat/minichat2/img/header_bg2_1.png')";
				}
				else
				{
					...
					t.style.backgroundImage = "url('https://www16.53kf.com/style/chat/minichat2/img/min.png')";
				...
				}                   $53("mini_header_bg_div").style.backgroundImage = "url('https://www16.53kf.com/style/chat/minichat2/img/header_bg_1.png')";
...
///////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
   ...
   //                  onliner_zdfq = 0;
			// 	}
   //              if(acc_autotype == 3) {onliner_zdfq = 3;document.cookie = "onliner_zdfq72195265="+onliner_zdfq;}
   //              hz6d_startReautoTimer();//邀请框反复发起
			...
			function get_ACCWindow(){
				...
				if (pc_ivt_type == '2') {//新版自定义 定位百分比计算
					...
					var wid=$53.getWH().W;
	    			var hei=$53.getWH().H;
	    			$53("kfivtwin").firstChild.style.left =(wid-parseInt($53("kfivtwin").firstChild.children[0].style.width))*(90/100) + 'px';
	    			$53("kfivtwin").firstChild.style.top = (hei-parseInt($53("kfivtwin").firstChild.children[0].offsetHeight))*(80/100) - 64 + 'px';
	    			return;
				}
			...
			function ivt_seturl(zdy_yqk)
			{
				var divs_str = zdy_yqk.replace(/operating="([^"]*)"/g,function(str){
					...
					if(vals[1])
					{
						...
						{
							case 'KF':
								var click_open_url = 'window.open(\"https://www16.53kf.com/webCompany.php?arg=10195265&style=1&kflist=off&kf=&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Flocalhost%3A9527%2F%23%2Fgoods%2Flist&keyword=http%3A%2F%2Flocalhost%3A9527%2F&brief=&logo=&question=&uid=8ba83dfc9d42be9ad1e4d0eb65a95a51&tfrom=2\",\"_blank\",\"height=600,width=800,top=50,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\")';
								...
								break;
								//click_str ='onliner_zdfq=2;get_open_start();window.open(\"https://www16.53kf.com/webCompany.php?arg=10195265&style=1&kflist=off&kf=&zdkf_type=1&lnk_overflow=0&language=zh-cn&charset=GBK&username=&userinfo=&introurl=&lyurl=&lytype=0&copartner=&referer=http%3A%2F%2Flocalhost%3A9527%2F%23%2Fgoods%2Flist&keyword=http%3A%2F%2Flocalhost%3A9527%2F&brief=&logo=&question=&uid=8ba83dfc9d42be9ad1e4d0eb65a95a51&tfrom=2\",\"_blank\",\"height=473,width=703,top=200,left=200,status=yes,toolbar=no,menubar=no,resizable=yes,scrollbars=no,location=no,titlebar=no\");hidden_ivt();';break;
							case 'CLOSE':
								click_str = 'onliner_zdfq=3;jtfq_type=1;hidden_ivt();'; break;
							case 'ETEL':
								click_str = 'window.open(\'https://tb.53kf.com/eht.php?company_id=72195265&style_id=106262622\',\'_blank\',\'height=400,width=300,top=100,left=200,status=yes,toolbar=no,menubar=no,resizable=no,scrollbars=no,location=no,titlebar=no\')';break;
							case 'QQ':
								if(valst[1]){
									if(valst[1].toLowerCase().indexOf('biz') > -1){
										var qq = valst[1].replace('biz','');
										link_str = 'https://www16.53kf.com/bizqq.php?qq=' + qq + '&from=' + window.encodeURIComponent(window.location.href);
									}else{
